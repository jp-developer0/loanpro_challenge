...
const ToDoList = () => {
  ...
  return (
    <>
      ...
      >
        <Form>
          <div className="flex justify-center items-center p-20 font-calibri text-white">
            <div className="flex gap-3 flex-col justify-start items-start  p-11 bg-slate-600 rounded-md">
              ...
              />
              <button
                className="bg-green-700 p-1.5 w-1/2 rounded-2xl"
                type="submit"
              >
                ADD
              </button>
      ...
      <div className=" w-1/2 flex flex-col gap-2 justify-center mr-auto ml-auto items-center font-calibri text-white">
        {todo.map((item, index) => (
          <label
            key={index}
